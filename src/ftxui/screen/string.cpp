...
// East Asian Wide/Fullwidth (EastAsianWidth.txt, property W or F) unioned with
// default emoji-presentation glyphs (emoji-data.txt, Emoji_Presentation), as of
// Unicode 17.0.0. A base that is wide only WHEN followed by U+FE0F - e.g.
// U+26A0 warning, U+2764 heart - is deliberately absent here; string_width's
// VS16 peek widens those graphemes instead. Regenerate with tools/gen_fullwidth.py
// after a Unicode update (it prints a diff and refuses to shrink any range).
